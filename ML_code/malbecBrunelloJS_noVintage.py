...
if os.path.isdir(os.path.join(os.getcwd(), 'trainNV')):
    shutil.rmtree('trainNV')
...
x_dict= {'price':prices,'malbec':malbecs,'brunello':brunellos}
FEATURES = ["price","malbec","brunello"]
LABEL = "JS"
...
f = open('results_no_vintage.csv','w')
